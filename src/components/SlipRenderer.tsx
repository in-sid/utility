        ...
        >
          ...
          <div className="grid grid-cols-2 gap-8 mb-12">
            <div className="flex gap-2 items-baseline">
              ...
              <span className="font-bold flex-1">{data.vehicleNumber}</span>
            </div>
            <div className="flex gap-2 items-baseline">
              <span className="font-bold">Period:</span>
              <span className="flex-1">{formatValue(period.start, 'date')} to {formatValue(period.end, 'date')}</span>
            </div>
          </div>

          <div className="flex gap-2 items-baseline mb-12">
            <span className="font-bold">Driver Name:</span>
            <span className="font-bold flex-1">{data.driverName}</span>
          </div>

          {/* Auth Section */}
          <div className="mt-auto flex justify-end items-end relative pb-4">
